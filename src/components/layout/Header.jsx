    ...
    return (
        <Row style={{marginBottom: 32}}>
            <Col xs={{ span: 16 }} sm={{ span: 16 }} md={{ span: 16 }} lg={{ span: 16 }} xl={{ span: 16 }} xxl={{ span: 16 }}>
                <Title level={2} style={{ fontFamily: 'Outfit, sans-serif' }}>{header.title}</Title>
                <Paragraph style={{ marginBottom: 0, fontFamily: 'Outfit, sans-serif' }} type='secondary'>{header.description}</Paragraph>
            </Col>
