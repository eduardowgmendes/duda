                ...
                <Col span={24}>
                    <Flex vertical align='center' justify='center' style={{minHeight: '50vh'}}>
                        <Space direction='vertical' align='center' size='small' style={{ textAlign: 'center', width: '100%', userSelect: 'none' }}>
                            {link.icon}
                            <Title level={2} ellipsis={{ rows: 3, expandable: false, symbol: '...' }} style={{ color: 'inherit', wordBreak: 'keep-all', fontWeight: 'bold', fontFamily: 'Outfit, sans-serif' }}>{link.title}</Title>
